...
# Main-branch snapshot of {ArticleAvailabilityPlanner}, kept for battle-test
# comparisons against the refactored planner stack.
class ArticleAvailabilityPlannerLegacy
