class Init < ActiveRecord::Migration[7.0]
  def change
    ...
    create_table 'article_box_order_requirements', force: :cascade do |t|
      ...
      t.index %w[article_id box_id], name: 'index_article_box_order_requirements_on_article_and_box', unique: true
    ...
    create_table 'diet_participants', force: :cascade do |t|
      ...
      t.index %w[diet_id participant_id], name: 'index_diet_participants_on_diet_id_and_participant_id', unique: true
    ...
    create_table 'diets_ingredients', id: false, force: :cascade do |t|
      ...
      t.index %w[diet_id ingredient_id], name: 'index_diets_ingredients_on_diet_id_and_ingredient_id', unique: true
    ...
    create_table 'group_box_articles', force: :cascade do |t|
      ...
      t.index %w[group_id box_id article_id], name: 'index_group_box_articles_on_group_box_and_article',
                                              unique: true
    ...
    create_table 'group_meal_participations', force: :cascade do |t|
      ...
      t.datetime 'created_at', precision: 6, default: -> { 'CURRENT_TIMESTAMP' }, null: false
      t.datetime 'updated_at', precision: 6, default: -> { 'CURRENT_TIMESTAMP' }, null: false
      t.index %w[group_id meal_id participant_id],
              name: 'index_group_meal_participations_on_group_meal_participant', unique: true
    ...
    create_table 'hoards', force: :cascade do |t|
      ...
      t.datetime 'until', precision: 6, null: false
      t.datetime 'created_at', precision: 6, null: false
      t.datetime 'updated_at', precision: 6, null: false
    ...
    create_table 'ingredient_alternatives', force: :cascade do |t|
      ...
      t.index %w[ingredient_id alternative_id], name: 'index_ingredient_alternatives_on_ingredient_alternative',
                                                unique: true
      t.index %w[ingredient_id priority], name: 'index_ingredient_alternatives_on_ingredient_id_and_priority',
                                          unique: true
    ...
    create_table 'ingredient_weights', force: :cascade do |t|
      ...
      t.datetime 'created_at', precision: 6, null: false
      t.datetime 'updated_at', precision: 6, null: false
      t.index %w[ingredient_id unit], name: 'index_ingredient_weights_on_ingredient_id_and_unit', unique: true
    ...
    create_table 'meals', force: :cascade do |t|
      ...
      t.index %w[lama_slot_uuid recipe_id], name: 'index_meals_on_lama_slot_uuid_and_recipe_id', unique: true
    ...
    create_table 'missing_ingredients', force: :cascade do |t|
      ...
      t.index %w[group_id box_id ingredient_id unit],
              name: 'index_missing_ingredients_on_group_box_ingredient_and_unit', unique: true
    ...
    create_table 'negative_diet_ingredients', id: false, force: :cascade do |t|
      ...
      t.index %w[diet_id recipe_ingredient_id], name: 'index_negative_diet_ingredients_diet_recipe_ingredient',
                                                unique: true
    ...
    create_table 'order_articles', force: :cascade do |t|
      ...
      t.index %w[order_id article_id], name: 'index_order_articles_on_order_and_article', unique: true
    ...
    create_table 'packing_lane_article_stocks', force: :cascade do |t|
      ...
      t.index %w[packing_lane_id box_id article_id], name: 'packing_lane_article_stock_unique', unique: true
    ...
    create_table 'positive_diet_ingredients', id: false, force: :cascade do |t|
      t.bigint 'diet_id'
      t.bigint 'recipe_ingredient_id'
      t.index %w[diet_id recipe_ingredient_id], name: 'index_positive_diet_ingredients_diet_recipe_ingredient',
                                                unique: true
    ...
    create_table 'recipe_ingredients', force: :cascade do |t|
      ...
      t.index %w[recipe_id index], name: 'index_recipe_ingredients_on_recipe_id_and_index', unique: true
